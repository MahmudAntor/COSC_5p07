...
![client-graph](Task2/Visualization/client-graph.jpg)
![client-timeline](Task2/Visualization/client-timeline.jpg)
![client-metrics](Task2/Visualization/client-metrics.jpg)

---

- Server:
![server-graph](Task2/Visualization/server-graph.jpg)
![server-metricse](Task2/Visualization/server-metrics.jpg)
---
## Discussion:
